...
SuperMap.Layer.TDTLayer = SuperMap.Class(SuperMap.CanvasLayer, {
    ...
    /**
     * APIProperty: mode
     * {String} 道路图层、影像图层缩放模式,默认为道路图层缩放模式。
     * 可选值为：VECTOR, AERIAL
     */
    mode: 'VECTOR',
    ...
    //道路图层缩放级别11-12的URL
    VectorGroup2 : "http://tile${d}.tianditu.com/DataServer?T=B0312_Map1112&X=${x}&Y=${y}&L=${l}",
    //道路图层缩放级别13以上的URL
    ...
    AerialMarksGroup2 : "http://tile${d}.tianditu.com/DataServer?T=B0312_Anno1112&X=${x}&Y=${y}&L=${l}",
    //影像图层缩放级别13以上地图标记文字的URL
    AerialMarksGroup3 : "http://tile${d}.tianditu.com/DataServer?T=B0530_eImgAnno&X=${x}&Y=${y}&L=${l}",
    //影像图层缩放级别15以上地图标记文字的URL
    AerialMarksGroup4 : "http://tile${d}.tianditu.com/DataServer?T=siweiAnno68&X=${x}&Y=${y}&L=${l}",
...
(function() {
    ...
    function dowork() {
        ...
        layerBase = new SuperMap.Layer.TDTLayer();
        layerMark = new SuperMap.Layer.TDTLayer({isMarks: true});
        positionLayer = new SuperMap.Layer.Markers("Markers");
        map.addLayers([layerBase, layerMark, positionLayer]);
    ...
    function processCompleted(latitude,longitude) {
        ...
        positionLayer.addMarker(new SuperMap.Marker(new SuperMap.LonLat(longitude, latitude), icon));
